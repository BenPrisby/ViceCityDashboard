...
class VCHub final : public QObject
{
    ...
    Q_PROPERTY( QDateTime currentDateTime  READ currentDateTime     MEMBER currentDateTime_      NOTIFY currentDateTimeChanged )
    ...
    Q_PROPERTY( bool darkerBackground      READ darkerBackground    MEMBER darkerBackground_    NOTIFY darkerBackgroundChanged )
    Q_PROPERTY( bool screensaverEnabled    READ screensaverEnabled  MEMBER screensaverEnabled_  NOTIFY screensaverEnabledChanged )
    ...
    Q_PROPERTY( QVariantList scenes        READ scenes              MEMBER scenes_               NOTIFY scenesChanged )
    Q_PROPERTY( QString homeMap            READ homeMap             MEMBER homeMap_              NOTIFY homeMapChanged )
